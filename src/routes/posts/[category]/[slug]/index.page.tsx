...
const PostLoadableView: FC = () => {
  ...
  const queryResult = useQuery(
    `post-${slug}`,
    () => store.postStore.fetchBySlug(category, slug),
    {
  ...
  return (
    <DataLoadingView data={queryResult.data} store={store.postStore}>
      {/* @ts-ignore */}
      <PostView />
    </DataLoadingView>
  )
}
export default PostLoadableView
